...
<div className="flex flex-col items-center justify-center  text-center text-white">
  <div>
  <h1 className="text-4xl tracking-tighter mt-10 font-bold mb-10 font-serif bg-gradient-to-r from-black to-[#001E80] text-transparent bg-clip-text">Appraisal Portal</h1>
  <h1 className="text-4xl font-bold mb-10 text-black font-serif">Login / Register</h1>

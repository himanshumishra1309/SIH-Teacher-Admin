...
export default function ReleaseFeedbacks() {
  ...
  const handleRelease = () => {
    if (selectedCourses.length === 0) {
      toast({
        title: "Error",
        description: "Please select at least one course before releasing feedbacks.",
        variant: "destructive",
      });
      return;
    }
  ...
  const confirmRelease = () => {
    // Implement the actual release logic here
    toast({
      title: "Success",
      description: `Feedbacks have been released for ${selectedCourses.length} course(s).`,
      duration: 3000,
    });
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This action will release feedbacks for {selectedCourses.length} selected course(s). This action cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>

...
import { CalendarIcon, PaperclipIcon, SendIcon, ChevronLeftIcon, ChevronRightIcon, PlusIcon } from 'lucide-react'
...
const PostsPage = () => {
  ...
  const [newPost, setNewPost] = useState({ title: '', content: '', attachments: [] })
  const [currentPage, setCurrentPage] = useState(1)
  const [isCreatePostOpen, setIsCreatePostOpen] = useState(false)

  const handleCreatePost = (e) => {
    e.preventDefault()
    setPosts([{ id: Date.now(), ...newPost, createdAt: new Date() }, ...posts])
              ...
              <CardFooter className="flex justify-between">
                ...
                <Dialog>
                  ...
                  <DialogContent className="sm:max-w-[700px] max-h-[80vh] overflow-y-auto">
                    <DialogHeader>
                      <DialogTitle className="text-center">{post.title}</DialogTitle>
                    </DialogHeader>

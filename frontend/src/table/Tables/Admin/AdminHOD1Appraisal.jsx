    ...
    <div className="container mx-auto p-4 relative">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <p>Faculty Name:	Dr. John Doe</p>
          <p>Faculty Department: CSE</p>
          <p>Faculty Code: CSE10011</p>
        </div>
        ...
        <Card className="mb-8">
          ...
          <CardContent className="text-center">
            <p className="text-4xl font-bold mb-2">Rank : 1</p>
            <p className="text-xl text-gray-600">Performance : OutStanding</p>
            {/* <p className="text-xl text-gray-700 font-semibold">
              Points out of 100:{" "}
              {point !== null ? point.toFixed(2) : "Loading..."}
            </p> */}
          </CardContent>
        </Card>
        <div>
...
export default AdminHOD1Appraisal;

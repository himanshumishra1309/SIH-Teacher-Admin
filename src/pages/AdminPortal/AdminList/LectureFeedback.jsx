          ...
          >
            ...
            >
              ...
              <form onSubmit={handleFormSubmit} className="p-8">
                <h2 className="text-2xl font-bold mb-6 text-center text-gray-800 dark:text-gray-200">Send us your feedback</h2>
                {/* Form inputs */}
                ...
                <div className="mt-6">
                  ...
                  <div className="flex items-center">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Star
                        key={star}
                        className={`h-8 w-8 cursor-pointer transition-all duration-200 ${star <= formData.rating ? 'text-yellow-400 fill-yellow-400' : 'text-gray-300'}`}

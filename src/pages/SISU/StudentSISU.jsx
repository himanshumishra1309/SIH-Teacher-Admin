        ...
        <div className="container w-1/2" id="main">
          <div className="sign-up">
            <form onSubmit={handleSignUpSubmit}>
              ...
              <input className='border mb-2 p-2' id="qualification" type="text" placeholder="Enrollment No*" value={signupData.roll_no} onChange={handleSignupChange} required />
              <input className='border mb-2 p-2' id="experience" type="text" placeholder="Branch*" value={signupData.branch} onChange={handleSignupChange} required />
              <input className='border mb-2 p-2' id="experience" type="text" placeholder="Year*" value={signupData.year} onChange={handleSignupChange} required />

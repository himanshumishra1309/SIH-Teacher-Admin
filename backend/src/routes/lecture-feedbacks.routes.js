...
router.post('/feedback/subject/:subjectId', verifyTeacherJWT, releaseSingleFeedbackForm);
...
router.post('/feedback/form/:feedbackFormId', verifyStudentJWT, fillFeedbackForm);

// Route to get feedback for a specific subject taught by the teacher (for teachers)
router.get('/feedback/subject/:subject_name/:subject_code/:subject_credit/:branch/:year', verifyTeacherJWT, getFeedbackForSubject);

// Route to get student details who have submitted feedback for a specific subject (for teachers)
router.get('/feedback/students/:subject_name/:subject_code/:subject_credit/:branch/:year', verifyTeacherJWT, getStudentDetails);

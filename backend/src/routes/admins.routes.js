...
router.put('/me/avatar', verifyAdminJWT, upload.single('avatar'), updateAdminAvatar);
...
router.get('/branches/:branch/students', verifyAdminJWT, getAllTheStudentsOfParticularBranch);

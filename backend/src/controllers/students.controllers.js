...
const loginStudent = asyncHandler(async(req, res)=>{
  ...
  const {studentAccessToken, studentRefreshToken} = await generateAccessAndRefreshToken(user._id);
  ...
  .json(
      new ApiResponse(
          200,
          {
              user: loggedInUser, studentAccessToken, studentRefreshToken
          },
...
export {registerStudent, loginStudent, logoutStudent, getCurrentStudent, updateStudentAvatar, updateAccountDetails}
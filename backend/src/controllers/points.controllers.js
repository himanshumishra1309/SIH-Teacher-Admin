...
const completeJournalPoints = asyncHandler(async (req, res) => {
    ...
    const requestedTeacherRank = requestedTeacher
        ? aggregatedPoints.findIndex((entry) => entry._id.toString() === teacherId) + 1
        : null;
    const requestedTeacherPoints = requestedTeacher ? requestedTeacher.totalPoints : null;
    const requestedTeacherName = requestedTeacher ? requestedTeacher.teacher.name : null;
    ...
    res.status(200).json(new ApiResponse(200, response, "Journal points calculated successfully"));
});
...
const completeBooksPoints = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, response, "Book points calculated successfully"));
});
...
const completePatentPoints = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, response, "Patent points calculated successfully"));
...
const completeProjectsPoints = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, response, "Project points calculated successfully"));
...
const completeConferencePoints = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, response, "Conference points calculated successfully"));
...
const completeChapterPoints = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, response, "Chapter points calculated successfully"));
...
const completeSTTPPoints = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, response, "STTP points calculated successfully"));
...
const completeEventsConductedPoints = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, response, "Event points calculated successfully"));
...
const completeSeminarAttendedPoints = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, response, "Seminar points calculated successfully"));
...
const completeExpertLecturesPoints = asyncHandler(async (req, res) => {
    ...
    const expertLecturesPoints = expertLecturesDomains.reduce((acc, domain) => {
        const entry = expertLecturesPointsBreakdown.find((item) => item._id === domain);
        acc[domain] = entry ? entry.totalPoints : 0;
        return acc;
    }, {});
    ...
    res.status(200).json(new ApiResponse(200, response, "Expert lecture points calculated successfully"));
...
const completeSeminarPoints = asyncHandler(async (req, res) => {
    ...
    if(!requestedTeacherRank || !requestedTeacherPoints || !requestedTeacherName) {

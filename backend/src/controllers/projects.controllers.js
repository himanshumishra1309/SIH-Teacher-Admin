...
const uploadProject = asyncHandler(async(req, res)=>{
    ...
    if([topic, branch_name, daily_duration, startDate, endDate].some((field)=> field.trim === "")){
...
const updateProject = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, updatedProject, "Project event updated successfully"));
});
...
const deleteProject = asyncHandler(async(req, res)=>{
    ...
    return res.status(200).json(new ApiResponse(201, null, "Project removed successfully"))
})

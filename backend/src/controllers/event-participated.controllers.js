...
const editParticipatedEvent = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, updatedEventParticipation, "Event updated successfully"));
});
...
const deleteParticipatedEvent = asyncHandler(async(req, res)=>{
    ...
    return res.status(200).json(new ApiResponse(200, null, "Event details deleted successfully"))
})

export { uploadParticipatedEvent, showAllParticipatedEvent, editParticipatedEvent, deleteParticipatedEvent }